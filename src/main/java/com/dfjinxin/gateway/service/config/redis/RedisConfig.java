package com.dfjinxin.gateway.service.config.redis;

import com.alibaba.fastjson.parser.ParserConfig;
import com.dfjinxin.gateway.service.config.redis.serializer.FastJsonRedisSerializer;
...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        ParserConfig.getGlobalInstance().addAccept("ai.ssy.business");
        return cacheManager;
    }
